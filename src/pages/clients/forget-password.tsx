...
const ForgetPassword = () => {
    ...
    return (
        <section className="forgot-password relative">
            <img src="https://i.ibb.co/8BPtqHz/Lupa-kata-sandi.png" className="h-screen lg:w-screen lg:h-full" alt="Background-Images" />
                    ...
                    <div className="bg-white mx-8 px-8 py-12 rounded-[27px] flex flex-col items-center">
                        <div className="flex flex-col items-center gap-10 lg:w-[458px]">
                            ...
                            <OtpInput
                                ...
                                inputStyle="mx-4 text-[32px] border-2 rounded-md focus:outline-none focus:border-blue-500 bg-[#E0E0E0]"
                            />
