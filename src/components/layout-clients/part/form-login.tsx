...
const FormLogin = ({ input, handleInput, handleLogin }) => {
    return(
        <div className="flex justify-center lg:items-center min-h-screen lg:min-h-screen lg:w-2/5 p-8">
            <div className="max-w-md w-full bg-white p-8 rounded-[27px] shadow-md">
                    ...
                    <form onSubmit={ handleLogin } className="flex flex-col gap-8 my-8">
                        <div className="flex flex-col gap-2">
                            <label className="font-[Open Sans] text-xl font-semibold text-[#505050]">Email/No. Handphone</label>
                            <input value={input.email} onChange={handleInput} name="email" type="text" className="h-[57px] rounded-full bg-gray-100 focus:outline-none p-6" />
                        </div>
                        <div className="flex flex-col gap-2">
                            <label className="font-[Open Sans] text-xl font-semibold text-[#505050]">Kata Sandi</label>
                            <input value={input.password} onChange={handleInput} type="password" name="password" className="h-[57px] rounded-full bg-gray-100 focus:outline-none p-6" />
