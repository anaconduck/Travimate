...
import planeBackground from "../../../assets/plane.png"

const Hero = () => {
    return (
        <div className="hero px-12 -mb-12 md:px-12 xl:px-32 h-[36rem] md:h-[50rem] bg-[url{planeBackground}] bg-no-repeat bg-fixed md:bg-[url('')] md:relative pt-12 bg-blue-500 rounded-bl-[72px] rounded-br-[72px] flex flex-row justify-between items-center">
            ...
            <div className="w-[60%] xl:w-[40%] h-[80%] md:h-[100%] hidden md:block md:absolute top-12 right-0">
                <img src={planeBackground} className="w-full h-full" alt="" />
            </div>
