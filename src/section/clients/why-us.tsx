    ...
    return (
        <section className='why-us container mx-auto my-16 px-4'>
            ...
            <div className="flex justify-between gap-10">
                <div className="flex flex-col items-center gap-4 px-7 pb-7 text-center w-1/3 bg-blue-500 rounded-3xl">
                ...
                <div className="flex flex-col items-center gap-4 pb-7 px-7 text-center w-1/3 bg-blue-500 rounded-3xl">
                    <div className='flex justify-center'>
                        <img src={Ellipse} alt="Ellipse Illustration" />
                    </div>
                    <div className='flex justify-center'>
