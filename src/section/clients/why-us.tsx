    ...
    return (
        <section className='why-us px-8 xl:px-32 mx-auto my-16'>
            ...
            <div className="flex flex-col md:flex-row justify-between gap-10">
                <div className="flex flex-col items-center gap-4 px-7 pb-7 text-center w-full md:w-1/3 bg-blue-500 rounded-3xl">
                ...
                <div className="flex flex-col items-center gap-4 pb-7 px-7 text-center w-full md:w-1/3 bg-blue-500 rounded-3xl">
                    <div className='flex justify-center'>
                        <img src={Ellipse} alt="Ellipse Illustration" />
                    </div>
                    <div className='flex justify-center'>
